...
const TaskNode = ({ id, data, skipHandles = false }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(framer_motion_1.motion.div, { animate: { scale: isDragging ? 1.06 : 1, transition: { type: 'spring', stiffness: 320, damping: 18 } }, className: (() => {
            ...
            if (Array.from(e.dataTransfer.types).includes('application/x-user-id')) {
                ...
                if (uid)
        ...
        }, children: [(0, jsx_runtime_1.jsx)(Ripple, { active: hasRipple }), hasAssignee && assignee && ((0, jsx_runtime_1.jsxs)("div", { className: "pointer-events-none absolute top-1 left-1 z-30 flex flex-col items-center", children: [assignee.avatarUrl ? ((0, jsx_runtime_1.jsx)("img", { src: assignee.avatarUrl, alt: assignee.name, className: "w-8 h-8 rounded-full border object-cover shadow" })) : ((0, jsx_runtime_1.jsx)("span", { className: "inline-block w-8 h-8 rounded-full border shadow", style: { background: assignee.color } })), (0, jsx_runtime_1.jsx)("span", { className: "mt-0.5 text-[10px] text-slate-700 leading-none bg-white/90 px-1 rounded shadow", children: assignee.name })] })), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-2 mb-1", children: [(0, jsx_runtime_1.jsx)("button", { className: `nodrag nopan min-w-[28px] min-h-[28px] w-7 h-7 rounded-full border-2 flex items-center justify-center transition-all hover:scale-110 active:scale-95 cursor-pointer ${isDone ? 'bg-emerald-500 border-emerald-600 text-white' : 'bg-slate-200 border-slate-400 text-slate-600 hover:bg-slate-300'}`, style: { fontSize: '14px', pointerEvents: 'auto', touchAction: 'manipulation' }, title: isDone ? '完了' : '未完了', "aria-label": "\u5B8C\u4E86\u5207\u66FF", onPointerDown: (e) => {
                            e.stopPropagation();
                            e.preventDefault();
                    ...
                    updateTask(id, { title: titleDraft }); }, onKeyDown: (e) => e.stopPropagation(), onDoubleClick: (e) => e.stopPropagation(), autoComplete: "off", spellCheck: false, autoCorrect: "off", autoCapitalize: "off", placeholder: "\u30BF\u30B9\u30AF\u540D", "aria-label": "\u30BF\u30B9\u30AF\u540D" }), (0, jsx_runtime_1.jsxs)("div", { className: "mt-1 flex items-center gap-2", children: [(0, jsx_runtime_1.jsx)("input", { type: "date", className: "text-[12px] border rounded px-1 py-0.5 nodrag nopan", value: task.deadline.dateISO ?? '', onChange: (e) => updateTask(id, { deadline: { dateISO: e.target.value || null } }), "aria-label": "\u7DE0\u5207" }), (0, jsx_runtime_1.jsx)("span", { className: "text-[11px] text-slate-500", children: remaining === null ? '締切未設定' : `${remaining} 日` }), (0, jsx_runtime_1.jsx)("button", { className: "ml-auto text-[12px] px-1 rounded hover:bg-slate-100", onClick: (e) => { e.stopPropagation(); toggleExpand(id); }, title: "\u5C55\u958B/\u6298\u308A\u305F\u305F\u307F", "aria-label": "\u5C55\u958B/\u6298\u308A\u305F\u305F\u307F", children: "\u25B8/\u25BE" })] }), (0, jsx_runtime_1.jsxs)("div", { className: "mt-1", children: [(0, jsx_runtime_1.jsx)("button", { className: "text-[11px] px-1 rounded hover:bg-slate-100", onClick: (e) => { e.stopPropagation(); setMemoOpen((v) => !v); }, "aria-label": "\u30E1\u30E2", children: "\u270E \u30E1\u30E2" }), memoOpen && ((0, jsx_runtime_1.jsx)("textarea", { ref: memoRef, className: "mt-1 w-full h-16 text-[12px] border rounded p-1 nodrag nopan resize-none", value: task.memo ?? '', onChange: (e) => updateTask(id, { memo: e.target.value }), onPointerDown: (e) => e.stopPropagation(), onMouseDown: (e) => {
                            e.stopPropagation();
                        }, onClick: (e) => {
                            e.stopPropagation();
                        }, onFocus: (e) => {
                            e.stopPropagation();
                        }, draggable: false, placeholder: "\u30E1\u30E2", title: "\u30E1\u30E2", "aria-label": "\u30E1\u30E2" }))] }), !skipHandles && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(reactflow_1.Handle, { type: "source", position: reactflow_1.Position.Right, style: { opacity: 0 } }), (0, jsx_runtime_1.jsx)(reactflow_1.Handle, { type: "target", position: reactflow_1.Position.Left, style: { opacity: 0 } })] }))] }));
};
